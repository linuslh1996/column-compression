...
mv benchmark_results.txt benchmark_results_nolto.csv
...
zip greenfield_results.zip  bits_per_int.csv benchmark_results.txt bits_per_int_nolto.csv benchmark_results_nolto.csv
